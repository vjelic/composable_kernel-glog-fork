...
struct GemmSplitKHostArgs : public ck_tile::GemmHostArgs
{
    ...
    CK_TILE_HOST GemmSplitKHostArgs(const void* a_ptr_,
        ...
        : BaseArgs(a_ptr_, b_ptr_, workspace_ptr_, k_batch_, M_, N_, K_, // Base e_ptr = workspace_ptr
                   stride_A_, stride_B_, workspace_stride_),
...
float gemm_stage1(const GemmSplitKHostArgs& args, const ck_tile::stream_config& s)
{
    ...
    using GemmUniversalTraits = ck_tile::TileGemmUniversalTraits<GemmConfig::kPadM,
                                                                 ...
                                                                 true>; // Enable workspace mode for split-K reduction
 ...
 * @param stride_A, stride_B, stride_C Memory strides
 * @param kbatch Number of K-splits for split-K execution
 * @param n_warmup, n_repeat Benchmarking parameters
